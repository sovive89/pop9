...
import { ArrowLeft, Flame, Users, UtensilsCrossed, KeyRound, LayoutGrid, BarChart3, Package, Map, ChefHat, Settings, Link2, Webhook, ExternalLink, MessageCircle, Contact, Printer } from "lucide-react";
...
import PrintServerTab from "@/components/admin/PrintServerTab";
      ...
      <main className="mx-auto max-w-4xl p-4">
        <Tabs defaultValue="menu" className="space-y-4">
          <TabsList className="flex flex-wrap h-auto gap-1 p-1">
            ...
            <TabsTrigger value="print-server" className="gap-2 text-xs sm:text-sm">
              <Printer className="h-4 w-4" />
              <span className="hidden sm:inline">Print Server</span>
            </TabsTrigger>
          ...
          <TabsContent value="print-server"><PrintServerTab /></TabsContent>
